...
public class WebGrab extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String url)
        ...
        while((page = in.readLine()) != null) {
            ...
            //out.println("Malformed URL. Check you typed it in correctly, include https:// at the beginning <br>"
            //        + "<a href='http://localhost:8080/UsingServlets/WebPageGrab.html'>Go back</a>"
            //        + "<br>" + url.substring(0, 4));
